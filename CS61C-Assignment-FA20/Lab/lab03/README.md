...
- Open [https://venus.cs61c.org](https://venus.cs61c.org/) in your web browser. In the Venus terminal, run `mount local vmfs` (if you chose a different port, replace “local” with the full URL, such as `http://localhost:6162`). This connects Venus to your file system.
...
You will find it helpful to refer to the [RISC-V green card](https://www.learncs.site/assets/files/riscvcard-75f9fb3a791fab6eee17d3cf216f77f0.pdf) to complete this exercise. If you encounter any instructions or pseudo-instructions you are unfamiliar with, use this as a resource.
