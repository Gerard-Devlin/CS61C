...
For this exercise, you will find the [GDB reference card useful](https://www.learncs.site/assets/files/gdb5-refcard-89fdebb2475f348ded03071dd13271df.pdf). GDB stands for “GNU De-Bugger.” Compile `hello.c` with the `-g` flag:
