...
The Game of Life is usually played on a bitmap (black and white) image over many timesteps, in which each pixel (or bit) is either 1 (alive) or 0 (dead). The [original rules for the Game of Life](https://en.wikipedia.org/wiki/Conway's_Game_of_Life#Rules) are reprinted below:
...
![img](https://www.learncs.site/assets/images/multi-27e2e54bce139b448e7096bb3abde028.gif)
...
![img](https://www.learncs.site/assets/images/multicolor-6005660da8fed55b94d4dbb4122eed5d.gif)
