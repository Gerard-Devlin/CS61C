...
- Pay close attention to the [calling convention](https://www.learncs.site/assets/files/RISCV_Calling_Convention-fb38c62ecbe1cc07ab5b25522d6192e4.pdf).
...
![img](https://www.learncs.site/assets/images/row_major-d8373e2845deec599796b9b6b866d52d.png)
...
*Note*: This function takes in the stride for each vector as an argument. Make sure you’re considering this when calculating your memory addresses. Consider re-reading the section on [array strides](https://www.learncs.site/docs/curriculum-resource/cs61c/projects/proj2#array-strides) in the background materials.
...
*Hint*: The stride for row vectors will be different than the stride for column vectors when calling the `dot` function. Consider re-reading the section on [array strides](https://www.learncs.site/docs/curriculum-resource/cs61c/projects/proj2#array-strides) in the background materials.
...
*Hint*: make sure to consult the [general advice and grading](https://www.learncs.site/docs/curriculum-resource/cs61c/projects/proj2#general-advice-and-grading) section if you want to improve your submission.
...
![img](https://www.learncs.site/assets/images/neuron-c37a8fe189d2760adbe7d10f4ee85a01.png)
...
![img](https://www.learncs.site/assets/images/XOR-2d5cbd363482b5e0cf7833b3120402d1.png)
...
![img](https://www.learncs.site/assets/images/mtx-6b18381be34279506b9217faafc22058.png)
...
![img](https://www.learncs.site/assets/images/MNIST-93d8a20e87629724ef72c5f52c7ea826.png)
...
![img](https://www.learncs.site/assets/images/little_endian-eeed71cfe93c6a8f198671d4c98656ff.png)
...
- **Q R.2**: How can we tell if `fopen` failed?
  **A R.2**: Please read the section on `fopen` in the [project spec](https://www.learncs.site/docs/curriculum-resource/cs61c/projects/proj2#file-operations).
...
- **Q C.1**: Can we assume that the input matrix is flattened?
  **A C.1**: The inputs to the MNIST and the `simple0` networks will be matrices with N rows and a single column. You can look at example inputs like this: `cat inputs/simple0/txt/inputs/input0.txt`. However, the simple2 network actually expects inputs with more than one column. Please consult the [project spec](https://www.learncs.site/docs/curriculum-resource/cs61c/projects/proj2#simple) to try and understand how to handle that case.
